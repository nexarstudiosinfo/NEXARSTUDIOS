  ...
  return (
    <div className="relative min-h-screen pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/4 left-1/4 w-[250px] h-[250px] md:w-[500px] md:h-[500px] bg-blue-200/30 rounded-full blur-[80px] md:blur-[100px] animate-blob" />
        <div className="absolute top-1/3 right-1/4 w-[200px] h-[200px] md:w-[400px] md:h-[400px] bg-cyan-200/30 rounded-full blur-[80px] md:blur-[100px] animate-blob animation-delay-2000" />
        <div className="absolute bottom-1/4 left-1/2 w-[250px] h-[250px] md:w-[600px] md:h-[600px] bg-indigo-200/20 rounded-full blur-[100px] md:blur-[120px] animate-blob animation-delay-4000" />
      </div>

      <main className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-center py-12 md:py-20">
        ...
        >
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-surface-container-high border border-outline-variant/30 text-[10px] md:text-xs font-bold tracking-widest uppercase text-on-surface-variant w-fit">
        ...
        <motion.div 
          ...
          className="relative w-full aspect-square mt-6 md:mt-10 lg:mt-0"
        >
