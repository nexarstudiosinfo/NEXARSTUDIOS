            ...
            <form className="space-y-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input 
                    ...
                    className="w-full bg-transparent border-0 border-b border-outline-variant focus:border-primary px-1 py-4 text-lg text-on-surface outline-none"
                  />
                </div>
                ...
                <div className="flex flex-wrap gap-4">
                  {['Web Design', 'App Development', 'Branding', 'Other'].map(type => (
                    <label key={type} className="cursor-pointer group">
                      ...
                      <span className="inline-block px-8 py-3 rounded-full border border-outline-variant text-on-surface-variant text-sm font-semibold transition-all peer-checked:bg-primary-container peer-checked:text-on-primary-container peer-checked:border-primary-container group-hover:bg-slate-50">
                        {type}
                      </span>
                    </label>
                  ))}
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea 
                  ...
                  className="w-full bg-transparent border-0 border-b border-outline-variant focus:border-primary px-1 py-4 text-lg text-on-surface outline-none resize-none"
                />
              </div>
              ...
              <div className="pt-6">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="bg-on-surface text-surface px-12 py-5 rounded-full text-sm font-bold flex items-center justify-center gap-3 hover:bg-slate-800 transition-colors cursor-pointer"
                >
                  Send Message
                  <ArrowRight size={20} />
                </motion.button>
        ...
        <div className="lg:hidden xl:flex xl:col-span-4 flex flex-col gap-10">
          ...
          <div className="bg-white border border-outline/10 rounded-[2rem] p-10 flex flex-col gap-10 h-full shadow-lg">
              ...
              {[
                ...
                <div key={i} className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    {item.href ? (
                      <a href={item.href} className="text-lg text-on-surface hover:text-primary">
                        {item.value}
                      </a>
                    ) : (
            ...
            <div className="mt-auto pt-10 border-t border-outline/10">
              <p className="text-[10px] uppercase font-bold tracking-widest text-on-surface-variant mb-6">
                Connect with us
              </p>

              <div className="flex gap-4">
                {[Globe, Share2].map((Icon, i) => (
                  <button key={i} className="w-12 h-12 rounded-full bg-slate-100 hover:bg-primary hover:text-on-primary transition-all flex items-center justify-center text-slate-600">
                    <Icon size={20} />
                  </button>
                ))}
              </div>
